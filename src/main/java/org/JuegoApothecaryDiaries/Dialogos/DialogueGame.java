...
/*
        ...
        Predicate<GameState> condicionConfianza = confianzacond -> state.getScore("guardia") >= 5;

        // Transiciones
        intro.addOption(new DialogueEdge("Decir la verdad", confianza , +5, condicionConfianza));
        ...
        while (current != null) {
            ...
            current = grafoDialogo.getNodoPorId(selected.getDestinoId());
        }
